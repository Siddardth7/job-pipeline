...
def generate():
    ...
    # summary is mod1_summary_latex from the frontend — already valid LaTeX
    # (contains \textbf{} commands). sanitize_latex would destroy those by
    # escaping backslashes, causing literal \textbf{} to appear in the PDF.
