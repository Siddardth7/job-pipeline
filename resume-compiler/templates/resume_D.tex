...
\skillline{Simulation \& Analysis:}{ABAQUS, ANSYS Fluent, FEA (Structural \& Thermal), Classical Lamination Theory, HyperWorks, MOOSE Framework}
...
\vspace{1pt}
\hspace{0.12in}{\fontsize{9pt}{11pt}\selectfont\textbf{\textit{Relevant Coursework:}} \textit{Manufacturing Processes, Finite Element Methods, Composite Materials, Structural Mechanics, Materials Characterization}}
